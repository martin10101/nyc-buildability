---
name: loop-resume
description: "Clear the manual pause (refused while a durable emergency stop is set) via the external supervisor CLI."
disable-model-invocation: true
---

# /loop-resume — thin owner control over the external supervisor (D-024 M0-T094; R083/R158)

User-only (the model may not invoke this). Normally the literal `/loop-resume` input is intercepted
