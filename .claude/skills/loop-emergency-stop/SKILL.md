---
name: loop-emergency-stop
description: "EMERGENCY stop: terminate child trees, cancel wakes, revoke approvals, set the durable stop flag; only 'stop --clear' clears it."
disable-model-invocation: true
---

# /loop-emergency-stop — thin owner control over the external supervisor (D-024 M0-T094; R083/R158)

User-only (the model may not invoke this). Normally the literal `/loop-emergency-stop` input is intercepted
