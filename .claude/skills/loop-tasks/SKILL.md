---
name: loop-tasks
description: "Campaign orientation: the machine-validated campaign record's NEXT action and restrictions - no model call."
disable-model-invocation: true
---

# /loop-tasks — thin owner control over the external supervisor (D-024 M0-T094; R083/R158)

User-only (the model may not invoke this). Normally the literal `/loop-tasks` input is intercepted
