...
All changes use migrations. Test forward/rollback behavior and cross-organization denial. Keep service-role credentials server-side. Use pgvector only for retrieval, never legal authority.
