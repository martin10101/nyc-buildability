...
19. Communication (D-064): plain facts, short sentences, no jargon, no over-explaining, no hedging or selling — answer only the question asked. Applies to owner-facing replies, subagent prompts and returns, and Codex-bridge messages.
