# D-004 amendment 26 — owner message (verbatim capture)
...
- Amends: source-025-amendment.md (V1.2 model-identity scope extension)
- Cross-registry note: the same owner message is captured verbatim as D-007 amendment 11
  (D-007-codex-claude-supervisor-bridge/source-012-amendment.md); supervisor-unit and sequencing
  requirement IDs live there (D-007-R597..R602), model-governance requirement IDs live here
  (D-004-R746..R750).
