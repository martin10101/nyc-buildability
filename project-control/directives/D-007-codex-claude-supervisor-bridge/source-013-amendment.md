# D-007 amendment 12 — owner message (verbatim capture)
...
- Amends: source-012-amendment.md (evening authorization; V1.2.1 quota-substitution scope)
- Cross-registry note: the same owner message is captured verbatim as D-004 amendment 27
  (D-004-agent-teams-runtime-adoption/source-027-amendment.md). Model-governance requirement IDs
  live there (D-004-R751..R760); supervisor-unit, sequencing, and hold IDs live here
  (D-007-R603..R609).
