# M5-T073 — second, late directive-compliance verification (directive-compliance-verifier "t073-dcv2", read-only) — corroboration only
...
> the gating record and changes no ledger state.
