# Snapshot: Claude Code Changelog
...
Latest released version: **2.1.246** (August 25, 2026).
Versions 2.1.244, 2.1.242, and 2.1.230 do not appear on the fetched page.
Versions below 2.1.220 omitted per snapshot scope (installed baseline is 2.1.220).
Capture method: WebFetch, two passes on 2026-08-26 (2.1.246–2.1.238 and 2.1.237–2.1.220), entries verbatim.
...
# Claude Code Changelog: Versions 2.1.220–2.1.237
