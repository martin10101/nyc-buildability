...
| 3 | Postgres-URI class (D2) | Live: `postgres://appuser:S3cr3tPw9zQxT@db.internal:5432/prod` → `postgres-uri-with-password`, password-only masked `S3cr...zQxT` | **FIXED** (residuals R1-D1/D3) |
